...
rootPath = "/media/Linux/Mallie_Dagmawi/PyTorch/data/Dataset/Model_2/"
...
transform_train = transforms.Compose([
                        ...
                        transforms.Normalize(mean=[0.18435], std = [0.15980]),
                ])
transform_val = transforms.Compose([
                        ...
                        transforms.Normalize(mean=[0.18528], std = [0.16014])
                ])
...
# If desired, copy weights from the pretrained model and average them across the 3 RGB channels
# with torch.no_grad():
#     model.conv1.weight[:, 0] = original_conv1.weight.mean(dim=1)  # Averaging across RGB channels
