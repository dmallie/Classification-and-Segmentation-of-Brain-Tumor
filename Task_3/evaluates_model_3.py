...
# In[] Set route path
testPath = "/media/Linux/Mallie_Dagmawi/PyTorch/data/Dataset/Model_3/Test/"
...
transform_fn = transforms.Compose([
                        ...
                        transforms.Normalize(mean=[0.17626], std = [0.16147])
                ])
